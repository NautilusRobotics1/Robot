...
//
//        // Initialize allContoursWithData w/ boundingRect area, and filter out one's with small area
...
//
//      if (!contourWithData.checkIfContourIsValid()) continue;
...
//        //  // if approx[k] is 3 then triangle
//        //  // else if approx[k] is 4 then rectangle / trapezoid
//        //}
//
//      }
//      // Note is it possible to change the image thresholding filter to look for RBY and then turn to black and white?
//        }
//
